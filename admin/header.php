      ...
      <div class="sidebar">
        ...
        <nav class="mt-3">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
            ...
            <?php
            $data_manage_pages = [
              'backup.php' => 'backup.manage',
              'restore.php' => 'restore.manage',
            ];

            $manage_active = in_array($current_page, array_keys($data_manage_pages));

            if (array_filter($data_manage_pages, fn($perm) => hasPermission($perm))): ?>
              <li class="nav-item has-treeview <?php echo $manage_active ? 'menu-open' : ''; ?>">
                ...
                <ul class="nav nav-treeview">
                  <?php foreach ($data_manage_pages as $file => $perm): ?>
