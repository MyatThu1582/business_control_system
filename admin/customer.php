 ...
 <?php include 'header.php';?>
  ...
  <?php
    ...
    if (empty($_POST['search'])) {
      ...
      $stmt = $pdo->prepare("SELECT * FROM customer ORDER BY id DESC LIMIT $offset,$numOfrecs");
      $stmt->execute();
          ...
          <div class="ml-1">
            <form class="" action="" method="post">
              <div class="input-group">
                <input type="text" class="form-control" placeholder="Search customer_Name" name="search">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <div class="container">
                    <a href="customer_edit.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-sm">
                    ...
                    <div class="contaienr">
                    <a href="customer_delete.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-sm delete-customer">
