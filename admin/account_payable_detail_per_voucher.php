...
<?php
  ...
  if(isset($_POST['update_remark'])) {
    ...
    $stmt = $pdo->prepare("UPDATE payable SET remark=:remark WHERE id=:id");
...
<div class="col-md-12 px-4 mt-4">
  <div class="d-flex justify-content-between">
    <div>
      <h4>Payment History For - <?php echo $supplierIdResult['supplier_name']; ?></h4>
    </div>
    <div>
      <?php
      $supplier_id = $_GET['supplier_id'];
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-flex">
            ...
            <!-- Drawer Backdrop -->
            <div id="drawerBackdrop<?php echo $value['id']; ?>" class="drawer-backdrop" onclick="closeDrawer(<?php echo $value['id']; ?>)"></div>
