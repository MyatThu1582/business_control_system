      ...
      <table class="table table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= $value['gin_no']; ?></td>
            <td><?= $value['remark']; ?></td>
            <td><?= number_format($total_amtdata['total_amt']); ?></td>
            <td>
              <div class="badge <?= ($value['status'] != 'draft') ? 'badge-primary' : 'badge-secondary'; ?>">
                <?= $value['status']; ?>
              </div>
            </td>
            <td class="text-center">
              <a href="sale_return_detail.php?grn_no=<?= $value['grn_no']; ?>&gin_no=<?= $value['gin_no']; ?>" class="link mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  class="bi bi-eye-fill" viewBox="0 0 16 16">
                  <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/>
                  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 
                    3.5 3.5 0 0 0 0 7"/>
                </svg>
              </a>
            </td>
